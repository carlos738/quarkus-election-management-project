...
@ApplicationScoped
public abstract class SQLCandidateRepository implements CandidateRepository {
    ...
    @Override
    public void save(List<api.dto.Election.Candidate> candidates) {
    ...
    @Override
    public List<Object> find(CandidateQuery query) {
